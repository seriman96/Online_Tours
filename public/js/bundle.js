...
//these 2 lines should be done inside index.js file
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    //map here is related to our id map in tour.pug file
    style: 'mapbox://styles/doumbia/cl4hftgu1004i15nyp898pnv1',
    //come from studio mapbox
  ...
  var bounds = new mapboxgl.LngLatBounds(); //bounds object here is the area that will be display on the map n we'll extend that with all of our tour locations.
  //looping through the tour locations array the one we got it from the docs in above locations variable

  locations.forEach(function (loc) {
    //create marker
    var el = document.createElement('div'); //js create elt method here div elt
  ...
  map.fitBounds(bounds, {
    padding: {
      top: 200,
      //used to add some style to our elt inside bounds n here it's about movement 
      bottom: 200,
      left: 100,
      right: 100
    }
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(names, emails, passwords, passwordconfirms) {
    var res;
...
var creatUsr = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(names, emails, passwords, passwordconfirms, types) {
    var res;
  ...
  return function creatUsr(_x5, _x6, _x7, _x8, _x9) {
...
var createc = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(names, durations, MaxGroupSize, difficulties, ratingsAVG, ratingsQu, prices, summarys, descriptions, imageCovers, image, startDate, guide, discountPrices) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function createc(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13, _x14) {
    return _ref.apply(this, arguments);
  };
}();
...
var topc = /*#__PURE__*/function () {
  ...
  return function topc(_x15, _x16, _x17, _x18) {
    return _ref2.apply(this, arguments);
  };
}();
...
var updateCours = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _context7.prev = 0;
            //axios is used communicate btw back-end n front-end
  ...
  return function updateCours(_x23, _x24) {
...
var uploadCours = /*#__PURE__*/function () {
  ...
  return function uploadCours(_x25, _x26) {
...
var deleteCours = /*#__PURE__*/function () {
  ...
  return function deleteCours(_x27) {
...
var monthCours = /*#__PURE__*/function () {
  ...
  return function monthCours(_x28) {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            if (resp.data.status === 'success') {
              ...
              id = resp.data.data.data._id; //after one n half seconds load the front page(home page) .
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            if (resp.data.status === 'success') {
              ...
              ids = resp.data.data.data._id; //after one n half seconds load the front page(home page) .
...
var stripe = Stripe('pk_test_51LHpCiSCB5NJWvoB2ZyCheev4C14IPVUbSI0XR8XxrZF2cuP5Ka8FzPRYuryZ9AQ60aN0Aoh8jHIQE4ZWsxRoMKZ00UnnhgqpO'); //it's a public key
...
var userPasswordForm = document.querySelector('.form-user-password'); //user managing
...
if (creatus) {
  creatus.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value; //const contact = document.getElementById('contact').value;
    ...
    (0, _signup.creatUsr)(name, email, password, passwordConfirm, type);
  });
}
...
if (uC) {
  uC.addEventListener('submit', function (e) {
    ...
    var description = document.getElementById('description').value; //const course = document.getElementById('course').value;
    //const imageCover = document.getElementById('photo1').files[0];
    //const imageCover = e.target.photo1.files
    //console.log(imageCover);

    var formData = new FormData(); //console.log('space!!!');
    //var img = `${imageCover}`;
    //var imgs = img.split('\\')[2];
    //const images = document.getElementById('images').value;
    //const images = document.getElementById('photo').value;

    var images = e.target.photo.files; //console.log(images);
    ...
    var imageCover = e.target.photo1.files; //const imgc = `${imageCover.name}`
    //console.log(imgc);

    if (imageCover.length != 0) {
      var _iterator2 = _createForOfIteratorHelper(imageCover),
          _step2;

      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var _img = _step2.value;
          formData.append('imageCover', _img);
        }
      } catch (err) {
        _iterator2.e(err);
      } finally {
...
if (createC) {
  createC.addEventListener('submit', function (e) {
    ...
    (0, _createCourse.createc)(name, duration, maxgroupsize, difficulty, average, quantity, price, summary, description, imgs, imagess, startDates, guides, discountprice);
  });
}
...
if (mapbox) {
  //if elt exist
  var locations = JSON.parse(mapbox.dataset.locations); //document.getElementById('map').dataset.locations has a value in string bcs of JSON.stringify() in tour.pug n we'll convert to json
